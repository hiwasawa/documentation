...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Create a PCL visualizer in Qt to colorize clouds</title>
...
<div class="highlight-cpp"><div class="highlight"><pre>  <span class="k">public</span> <span class="nl">slots</span><span class="p">:</span>
...
<div class="highlight-cpp"><div class="highlight"><pre>  <span class="k">protected</span><span class="o">:</span>
...
<li><tt class="docutils literal"><span class="pre">viewer_</span></tt> is the visualizer object</li>
<li><tt class="docutils literal"><span class="pre">cloud_</span></tt> holds the point cloud displayed</li>
<li><tt class="docutils literal"><span class="pre">filtering_axis_</span></tt> stores on which axis we want to filter the point cloud. We need this variable because we only have one slot for 3 axes.</li>
<li><tt class="docutils literal"><span class="pre">color_mode_</span></tt> stores the color mode for the colorization, we need this variable for the same reason we need <tt class="docutils literal"><span class="pre">filtering_axis_</span></tt></li>
<li><tt class="docutils literal"><span class="pre">colorCloudDistances</span> <span class="pre">()</span></tt> is the member function that actually colorize the point cloud.</li>
</ul>
</dd>
</dl>
</div>
...
<div class="highlight-cpp"><div class="highlight"><pre><span class="n">PCLViewer</span><span class="o">::</span><span class="n">PCLViewer</span> <span class="p">(</span><span class="n">QWidget</span> <span class="o">*</span><span class="n">parent</span><span class="p">)</span> <span class="o">:</span>
...
<div class="highlight-cpp"><div class="highlight"><pre>  <span class="c1">// Connect &quot;Load&quot; and &quot;Save&quot; buttons and their functions</span>
...
<div class="highlight-cpp"><div class="highlight"><pre>  <span class="c1">// Color the randomly generated cloud</span>
...
<p>This functions deals with opening files, it supports both <tt class="docutils literal"><span class="pre">pcd</span></tt> and <tt class="docutils literal"><span class="pre">ply</span></tt> files.
...
<div class="line-block">
<div class="line">This functions deals with saving the displayed file, it supports both <tt class="docutils literal"><span class="pre">pcd</span></tt> and <tt class="docutils literal"><span class="pre">ply</span></tt> files.</div>
<div class="line">As said before, if the user doesn&#8217;t append an extension to the file name, <tt class="docutils literal"><span class="pre">ply</span></tt> will be automatically added.</div>
</div>
<div class="highlight-cpp"><div class="highlight"><pre><span class="kt">void</span>
...
the <tt class="docutils literal"><span class="pre">filtering_axis_</span></tt> member accordingly.</p>
<div class="highlight-cpp"><div class="highlight"><pre><span class="kt">void</span>
...
<p>This function is called whenever one of the radio buttons in the color list is clicked, the <tt class="docutils literal"><span class="pre">color_mode_</span></tt> member is modified accordingly.
...
<div class="highlight-cpp"><div class="highlight"><pre>  <span class="c1">// Search for the minimum/maximum</span>
...
<div class="highlight-cpp"><div class="highlight"><pre>  <span class="c1">// Compute LUT scaling to fit the full histogram spectrum</span>
...
The <tt class="docutils literal"><span class="pre">if</span></tt> condition is here in case of a perfectly flat point cloud and avoids exceptions thrown by boost.</p>
<div class="highlight-cpp"><div class="highlight"><pre>  <span class="k">for</span> <span class="p">(</span><span class="n">PointCloudT</span><span class="o">::</span><span class="n">iterator</span> <span class="n">cloud_it</span> <span class="o">=</span> <span class="n">cloud_</span><span class="o">-&gt;</span><span class="n">begin</span> <span class="p">();</span> <span class="n">cloud_it</span> <span class="o">!=</span> <span class="n">cloud_</span><span class="o">-&gt;</span><span class="n">end</span> <span class="p">();</span> <span class="o">++</span><span class="n">cloud_it</span><span class="p">)</span>
  <span class="p">{</span>
...
<p>We have computed how much we need to scale the distances to fit the RGB scale, we first need to round the <tt class="docutils literal"><span class="pre">double</span></tt> values to the closest <tt class="docutils literal"><span class="pre">integer</span></tt>
because colors are coded as integers.</p>
<div class="highlight-cpp"><div class="highlight"><pre>    <span class="c1">// Apply color to the cloud</span>
...
You can do whatever you want here, the simplest option is to apply the 3 channels (R,G,B) to the <tt class="docutils literal"><span class="pre">value</span></tt> computed, this means that the
minimum distance will translate into dark (black = 0,0,0) points and maximal distances into white (255,255,255) points.</p>
<div class="highlight-cpp"><div class="highlight"><pre>      <span class="k">case</span> <span class="mi">1</span><span class="o">:</span>
